	...
	public void put(long key, String value)
    {
		...
		while(true)
        {
        	if(putStatus.size() < 3)
            {
        		try
                {
        			System.out.println("Waiting for PUT requests to be processed on all three servers");
					Thread.sleep(500);
                }
            ...
            else
            {
                ...
                {
        			System.out.println("Successfully posted values");
        		}
        		putStatus.clear();
        		break;
        	}
	...
	public String get(long key)
    {
		...
		while(true)
        {
        	if(getStatus.size() < 3)
            {
        		try
                {
        			System.out.println("Waiting to get all requests ");
					Thread.sleep(1000);
				}
                catch (InterruptedException e)
                {
            ...
            else
            {
                ...
                {
        			System.out.println("Values are not consistent on all servers");
        			...
        			System.out.println("Making all values in the servers consistent");
